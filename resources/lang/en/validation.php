...
return [
    ...
    */
    ...
    "max" => [
        "numeric" => "Kolom :attribute Harus memiliki maximal karakter :max.",
        "file" =>
            "Kolom :attribute Harus memiliki maximal karakter :max kilobytes.",
        "string" =>
            "Kolom :attribute Harus memiliki maximal karakter :max characters.",
        "array" =>
            "Kolom :attribute Harus memiliki maximal karakter :max items.",
    ],
    "mimes" => "The :attribute must be a file of type: :values.",
    "mimetypes" => "The :attribute must be a file of type: :values.",
    "min" => [
        "numeric" => "Kolom :attribute Harus memiliki minimal karkter :min.",
        "file" =>
            "Kolom :attribute Harus memiliki minimal karkter :min kilobytes.",
        "string" =>
            "Kolom :attribute Harus memiliki minimal karkter :min characters.",
    ...
    "required" => "Kolom : Harus Di Isi dan tidak boleh kosong",
    "required_array_keys" =>
